      ...
      <div style={{flexDirection: "column", backgroundColor: 'white'}}>
          ...
          <div style={{height: 750, width: '100%', position: "relative"}}>
              ...
              <div style={{height: 200, width: '100%', position: "absolute", top: 0, backgroundColor: ''}}>
                  <div style={{height: 150, margin: 70, backgroundColor:'', display: 'flex', fontFamily: 'monospace'}}>
                      <div style={{flex: 1, marginRight: 80}}>
                          <span style={{fontSize: 18, lineHeight: 1}}>
                          We've all been in the business for a few years. Colleagues have come
                      and gone, projects and companies have changed in the world where technology is ever
                      evolving. We've stayed on that path, with its ups and downs,
                          </span><br/>
                                  <span style={{fontWeight: 'bold', fontSize: 30, lineHeight: 1}}>
                              following our passion for <br/>software.
                          </span>
                      </div>
                      <div style={{flex: 0.8, marginRight: 100}}>
                          <span style={{fontSize: 18, lineHeight: 1}}>
                          Somewhere along that path we met people that made a mark.
                          </span>
                                  <span style={{fontWeight: 'bold', fontSize: 30, lineHeight: 0.7}}>
                              People that challenged and inspired us,
                          </span>
                                  <span style={{fontSize: 18, lineHeight: 1}}>
